...
```
## Plot Sankey (default)
It's as easy as that! This plot is interactive, so click around to explore the dataset. 

Note: increasing the number of taxa risks overplotting and the function slows down considerably. Interactive Sankey plots are better than stacked bar plots, but they still aren't perfect!
```{r message = FALSE}
